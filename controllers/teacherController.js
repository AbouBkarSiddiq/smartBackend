...
async function getAll(req, res) {
  try {
    ...
    res
      .status(500)
      .json({ error: "An error occurred while retrieving the teachers" });
  }
}
...
const updatedTeacher = async (req, res) => {
  try {
...
module.exports = { createTeacher, getSingle, getAll, updatedTeacher, remove, login };
